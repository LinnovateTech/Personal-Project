...
const Contato = () => {
    ...
    const handleSubmit = (e) => {
        e.preventDefault();
        emailjs.sendForm('service_9zg3pt5', 'template_v1bkecs', form.current, 'CT_BZaKrF5w_O3h8p')
            .then((result) => {
                setOpen(true);
                form.current.reset();
            }, (error) => {
    ...
    return (
        <Container>
            <Wrapper>
                <Title>Contato</Title>
                <Desc>
                    Entre em contato conosco se busca soluções inovadoras para impulsionar seu negócio!
                </Desc>
